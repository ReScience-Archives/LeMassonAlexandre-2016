...
\marginpar{
  ...
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Le\_Masson-Alexandre-2016/article}{\faGithubAlt~Article repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Le\_Masson-Alexandre-2016/code}{\faGithubAlt~Code repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Le\_Masson-Alexandre-2016/data}{\faGithubAlt~Data repository}
  \end{repobox}
      \vspace{-1mm}
  \begin{repobox}
    \bfseries\normalsize
      \href{https://github.com/ReScience-Archives/Le\_Masson-Alexandre-2016/notebook}{\faGithubAlt~Jupyter notebook}
  \end{repobox}
    \hypersetup{urlcolor=blue}
}
